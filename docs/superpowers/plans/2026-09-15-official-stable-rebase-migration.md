...
- [ ] 只读获取官方 tag `v2026.0901.0`，不新增 remote。
- [ ] 验证 annotated tag 对象及其 peeled commit，最终提交必须为 `7af5c3fffe2505c7cb764951bed863b16eee471b`。
- [ ] 从该提交创建 `codex/rebase-v2026.0901.0`。
- [ ] 在未加本地功能前完成纯官方基线构建和官方 testsuite，记录官方自身已知失败；纯官方基线不能用于启动江湖英杰传生产 mudlib。
